...
## Inputs
- Audit scope.
- Document request list if available.
- Any existing NDA template or confidentiality language.

## Instructions
1. Define what confidentiality concerns a target brand will likely have.
...
- Use one subagent to make the language less legalistic and more buyer-friendly.
